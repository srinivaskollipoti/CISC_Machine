...
class InstructionSet
{
	...
	static{
		instSet =   new Hashtable<Integer, Instruction>() {{
			...
			put(JMA,new Instruction("JMA",JMA,2,false,true,true,true,Instruction.InstType.TRANS_INST)); 	
			put(JSR,new Instruction("JSR",JSR,2,false,true,true,true,Instruction.InstType.TRANS_INST)); 	
